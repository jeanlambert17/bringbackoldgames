...
const navigation = {
  ...
  social: [
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/jeanlambert17',
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          {/* <div className="grid grid-cols-2 gap-8 mt-16 xl:col-span-2 xl:mt-0"> */}
            {/* <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="font-semibold text-white text-sm/6">Solutions</h3>
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.solutions.map((item) => (
                    <li key={item.name}>
                      <a href={item.href} className="text-gray-400 text-sm/6 hover:text-white">
                        {item.name}
                      </a>
                    </li>
                  ))}
